      ...
      <main className="flex flex-col items-center justify-center min-h-screen px-4">
        <section className="w-full max-w-screen-lg mx-auto my-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="relative col-span-2 row-span-2 bg-gradient-to-r from-blue-500 to-teal-500 text-white p-8 rounded-lg shadow-lg flex flex-col justify-end">
            ...
            {/* Smaller Blocks */}
            <div className="relative bg-gray-800 text-white p-8 rounded-lg shadow-lg">
            ...
            {/* Featured Projects */}
            <div className="relative col-span-2 bg-gray-700 text-white p-8 rounded-lg shadow-lg">
            ...
            {/* Call to Action */}
            <div className="relative bg-gradient-to-r from-purple-500 to-pink-500 text-white p-8 rounded-lg shadow-lg flex flex-col justify-center">
